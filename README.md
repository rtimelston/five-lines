...
# How to Build It
Assuming that you have the Typescript compiler installed: Open a terminal in this directory, then run `tsc -w`. There should now be a `index.js` file in this directory.
